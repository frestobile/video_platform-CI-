!function() {
    var a, n, s, d, t, o, e, i, l, r, m, c, u = document.querySelector(".navbar-menu").innerHTML, g = 6, b = "en", y = localStorage.getItem("language");
    function E() {
        p(null === y ? b : y);
    ...
    function p(e) {
        document.getElementById("header-lang-img") && ("en" == e ? (document.getElementById("header-lang-img").src = "assets/images/flags/us.svg",
        document.getElementById("lang-name").innerHTML = "English") : "sp" == e ? (document.getElementById("header-lang-img").src = "assets/images/flags/spain.svg",
        document.getElementById("lang-name").innerHTML = "Española") : "gr" == e ? (document.getElementById("header-lang-img").src = "assets/images/flags/germany.svg",
        document.getElementById("lang-name").innerHTML = "Deutsche") : "it" == e ? (document.getElementById("header-lang-img").src = "assets/images/flags/italy.svg",
        document.getElementById("lang-name").innerHTML = "Italiana") : "ru" == e ? (document.getElementById("header-lang-img").src = "assets/images/flags/russia.svg",
        document.getElementById("lang-name").innerHTML = "русский") : "ch" == e ? (document.getElementById("header-lang-img").src = "assets/images/flags/china.svg",
        document.getElementById("lang-name").innerHTML = "中国人") : "fr" == e ? (document.getElementById("header-lang-img").src = "assets/images/flags/french.svg",
        document.getElementById("lang-name").innerHTML = "français") : "ar" == e && (document.getElementById("header-lang-img").src = "assets/images/flags/ae.svg",
        document.getElementById("lang-name").innerHTML = "عربى"),
        localStorage.setItem("language", e),
        null == (y = localStorage.getItem("language")) && p(b),
        (e = new XMLHttpRequest).open(`GET`, `${_server_url}.assets/lang/` + y + ".json"),
    ...
    function A() {
        ...
        (a = a.substring(a.lastIndexOf("/") + 1)) && ("twocolumn-panel" == document.body.className && document.getElementById("two-column-menu").querySelector('.nav-icon[href="' + a + '"]').classList.add("active"),
    ...
    function B() {
        ...
        Array.from(n).forEach(function(e, t) {
            ...
            a < t + 1 && (o += e.outerHTML,
            e.remove()),
            t + 1 === n.length && s.insertAdjacentHTML && s.insertAdjacentHTML("afterend", '<li class="nav-item">\t\t\t\t\t\t<a class="nav-link" href="#sidebarMore" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarMore">\t\t\t\t\t\t\t<i class="ri-briefcase-2-line"></i> More\t\t\t\t\t\t</a>\t\t\t\t\t\t<div class="collapse menu-dropdown" id="sidebarMore"><ul class="nav nav-sm flex-column">' + o + "</ul></div>\t\t\t\t\t</li>")
        })
    }
    function k(e) {
    ...
    function z(e) {
        if (e == e) {
            ...
            case "twocolumn":
                ...
                break;
            default:
                "vertical" == sessionStorage.getItem("data-layout") && sessionStorage.getItem("data-layout") ? (x("data-layout", "vertical"),
                sessionStorage.setItem("data-layout", "vertical"),
                document.documentElement.setAttribute("data-layout", "vertical"),
                k("vertical"),
                f()) : "horizontal" == sessionStorage.getItem("data-layout") ? (x("data-layout", "horizontal"),
                sessionStorage.setItem("data-layout", "horizontal"),
                document.documentElement.setAttribute("data-layout", "horizontal"),
                k("horizontal")) : "twocolumn" == sessionStorage.getItem("data-layout") && (x("data-layout", "twocolumn"),
                sessionStorage.setItem("data-layout", "twocolumn"),
                document.documentElement.setAttribute("data-layout", "twocolumn"),
                k("twocolumn"))
            }
            ...
            case "dark":
                ...
                break;
            default:
                "dark" == sessionStorage.getItem("data-topbar") ? (x("data-topbar", "dark"),
                sessionStorage.setItem("data-topbar", "dark"),
                document.documentElement.setAttribute("data-topbar", "dark")) : (x("data-topbar", "light"),
                sessionStorage.setItem("data-topbar", "light"),
                document.documentElement.setAttribute("data-topbar", "light"))
            }
            ...
            case "detached":
                ...
                break;
            default:
                "detached" == sessionStorage.getItem("data-layout-style") ? (x("data-layout-style", "detached"),
                sessionStorage.setItem("data-layout-style", "detached"),
                document.documentElement.setAttribute("data-layout-style", "detached")) : (x("data-layout-style", "default"),
                sessionStorage.setItem("data-layout-style", "default"),
                document.documentElement.setAttribute("data-layout-style", "default"))
            }
            ...
            default:
                ...
                document.documentElement.setAttribute("data-bs-theme", "dark"),
                x("data-bs-theme", "dark")) : (sessionStorage.setItem("data-bs-theme", "light"),
                document.documentElement.setAttribute("data-bs-theme", "light"),
                x("data-bs-theme", "light"))
            }
            ...
            default:
                ...
                document.documentElement.setAttribute("data-layout-width", "boxed"),
                x("data-layout-width", "boxed")) : (sessionStorage.setItem("data-layout-width", "fluid"),
                document.documentElement.setAttribute("data-layout-width", "fluid"),
                x("data-layout-width", "fluid"))
            }
            ...
            case "scrollable":
                ...
                break;
            default:
                sessionStorage.getItem("data-layout-position") && "scrollable" == sessionStorage.getItem("data-layout-position") ? (x("data-layout-position", "scrollable"),
                sessionStorage.setItem("data-layout-position", "scrollable"),
                document.documentElement.setAttribute("data-layout-position", "scrollable")) : (x("data-layout-position", "fixed"),
                sessionStorage.setItem("data-layout-position", "fixed"),
                document.documentElement.setAttribute("data-layout-position", "fixed"))
            }
            ...
            default:
                var t;
                sessionStorage.getItem("data-preloader") && "disable" == sessionStorage.getItem("data-preloader") ? (x("data-preloader", "disable"),
                sessionStorage.setItem("data-preloader", "disable"),
                document.documentElement.setAttribute("data-preloader", "disable")) : "enable" == sessionStorage.getItem("data-preloader") ? (x("data-preloader", "enable"),
                sessionStorage.setItem("data-preloader", "enable"),
                document.documentElement.setAttribute("data-preloader", "enable"),
                (t = document.getElementById("preloader")) && window.addEventListener("load", function() {
                    t.style.opacity = "0",
    ...
    function x(a, e) {
        Array.from(document.querySelectorAll("input[name=" + a + "]")).forEach(function(t) {
            ...
            t.addEventListener("change", function() {
                ...
                f()) : "horizontal" == t.value ? (document.getElementById("sidebarimg-none") && document.getElementById("sidebarimg-none").click(),
                k("horizontal")) : "twocolumn" == t.value && (k("twocolumn"),
                document.documentElement.setAttribute("data-layout-width", "fluid"),
                document.getElementById("layout-width-fluid").click(),
                h(),
                A(),
                f())),
                "data-bs-theme" == a && "light" == t.value ? (document.getElementById("topbar-color-light").click(),
                document.getElementById("sidebar-color-light").click()) : "data-bs-theme" == a && "dark" == t.value && (document.getElementById("topbar-color-dark").click(),
    ...
    function N() {
        ...
        // }),
        // document.querySelector("#notificationItemsTabContent .empty-notification-elem") || (document.getElementById("notificationItemsTabContent").innerHTML += '<div class="empty-notification-elem text-center px-4">\t\t\t\t\t\t<div class="mt-3 avatar-md mx-auto">\t\t\t\t\t\t\t<div class="avatar-title bg-info-subtle text-info fs-24 rounded-circle">\t\t\t\t\t\t\t<i class="bi bi-bell "></i>\t\t\t\t\t\t\t</div>\t\t\t\t\t\t</div>\t\t\t\t\t\t<div class="pb-3 mt-2">\t\t\t\t\t\t\t<h6 class="fs-16 fw-semibold lh-base">Hey! You have no any notifications </h6>\t\t\t\t\t\t</div>\t\t\t\t\t</div>'))
    }
    function G() {
        var e;
    ...
    z(a)) : (i = document.documentElement.attributes,
    a = {},
    ...
    (d = document.getElementById("search-options")) && (d.addEventListener("focus", function() {
        ...
        n.classList.remove("d-none")) : (s.classList.remove("show"),
    ...
    d.addEventListener("keyup", function(e) {
        ...
        Array.from(t).forEach(function(e) {
            ...
            n && (n.includes(o) ? (e.classList.add("d-block"),
    ...
    t && o && e && (e.addEventListener("focus", function() {
        0 < e.value.length ? (o.classList.add("show"),
        t.classList.remove("d-none")) : (o.classList.remove("show"),
    ...
    document.body.addEventListener("click", function(e) {
        "search-options" !== e.target.getAttribute("id") && (o.classList.remove("show"),
        t.classList.add("d-none"))
    })),
    ...
    document.querySelectorAll("#light-dark-mode .dropdown-item").forEach(function(t) {
        t.addEventListener("click", function(e) {
            l.hasAttribute("data-bs-theme") && "light" == t.getAttribute("data-mode") ? (C("data-bs-theme", "light", "layout-mode-light", l),
            sessionStorage.setItem("data-layout-auto", "false")) : l.hasAttribute("data-bs-theme") && "dark" == t.getAttribute("data-mode") ? (C("data-bs-theme", "dark", "layout-mode-dark", l),
            sessionStorage.setItem("data-layout-auto", "false")) : l.hasAttribute("data-bs-theme") && "auto" == t.getAttribute("data-mode") && (window.matchMedia("(prefers-color-scheme: dark)").matches ? C("data-bs-theme", "dark", "layout-mode-dark", l) : C("data-bs-theme", "light", "layout-mode-light", l),
    ...
    M()),
    document.getElementsByClassName("notification-check") && (N(),
    ...
    m = document.getElementById("removeNotificationModal")) && m.addEventListener("show.bs.modal", function(e) {
    ...
    Array.from(m).forEach(function(e) {
        var t, a, n;
        "flatpickr" == e.getAttribute("data-provider") ? (t = {},
