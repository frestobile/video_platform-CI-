 ...
 */
?>
<link rel="stylesheet" charset="UTF-8" href="<?php echo base_url();?>public/css/pagination.css">
...
<div class="table-footer dataTables_paginate paging_simple_numbers">
    ...
    if($lastpage > 1)
    {
        ...
        if ($page < $counter - 1)
            ...
            $pagination.= '<span class="disabled"><i class="mdi mdi-chevron-double-right"></i></i></span>';
        $pagination.= '</div>';
    }
