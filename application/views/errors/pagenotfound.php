...
<head>
    ...
    <meta name="author" content="Frestobile - Senior Web&Mobile Dev">
                    ...
                    <div class="col-lg-3 col-md-5 col-sm-10 col-10 box-shadow-2 p-0">
                        <div class="card border-grey border-lighten-3 px-1 py-1 m-0" style="background-color: #aa0b2d;">
                            ...
                            <div class="card-content">
                                <div class="card-body">
                                    <div style="margin: 25px 0; background-color: white; border-radius: 3px;">
                                        <a href="<?php echo base_url(); ?>" class="btn btn-outline-info btn-block">Back to Home</a>
                                    </div>
                                </div>
                            </div>
                        </div>
